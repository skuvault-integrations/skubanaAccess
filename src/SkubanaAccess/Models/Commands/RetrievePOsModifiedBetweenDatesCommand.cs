...
{
	public class RetrievePOsModifiedBetweenDatesCommand : SkubanaCommand
	{
		public RetrievePOsModifiedBetweenDatesCommand( SkubanaConfig config, DateTime startDateUtc, DateTime endDateUtc, int page, int limit ) : base( config, SkubanaEndpoint.RetrievePurchaseOrdersUrl )
		{		
